...
contextBridge.exposeInMainWorld('captureApi', {
  appendQuickCapture: (text: string, targetFsPath?: string) => ipcRenderer.invoke('append-quick-capture', text, targetFsPath),
  listCaptureTargets: () => ipcRenderer.invoke('list-capture-targets'),
